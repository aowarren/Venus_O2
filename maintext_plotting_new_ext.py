...
if melt == 1:
    results_pd = pd.read_csv('C:\\Users\\sasha\\Box\\Clean Code\\results\\extra\\data_plots_wdH2O20_Ar_FULL.csv')
elif melt == 0:
    results_pd = pd.read_csv('C:\\Users\\sasha\\Box\\Clean Code\\results\\extra\\data_plots_nomelt_0_Ar_extra.csv')
...
title_m = 'e_wd_statistics_melt_CO_FMQ0.npz'
title_nm = 'e_statistics_nomelt_CO_FMQ0.npz'
...
ax.set_ylabel('Initial water (m GEL)', fontsize=80)
ax.invert_yaxis()
ax.set_xlabel('End of habitable era (Ga)', fontsize=80)
ax.tick_params(axis='both', which='major', labelsize=60)
ax.set_title('% successful runs', fontsize=80)
...
axs[2,0].set_yticks(np.linspace(-1,6,8))
...
ax4.set_yticks(np.linspace(-1,6,8))
...
axs[2,1].set_yticks(np.linspace(-1,6,8))
...
axs[3,2].set_xticks(np.linspace(-1,6,8))
...
fig7a,ax7a = plt.subplots(figsize=(30,20))
...
ax11.set_xticks(np.linspace(-1,6,8))
...
axs[5,2].set_xticks(np.linspace(-1,6,8))
...
ax14.set_xticks(np.linspace(-1,6,8))
...
axs[4,2].set_xticks(np.linspace(-1,6,8))
...
axs[6,2].set_xticks(np.linspace(-1,6,8))
...
axs[2,2].set_xticks(np.linspace(-1,6,8))
...
f_totals_Ar = f_totals_Ar[:-1,0]

f_totals_Ar_m = np.mean(f_totals_Ar) * f_totals_m
f_totals_Ar_nm = np.mean(f_totals_Ar) * f_totals_nm
...
bxs[3,0].set_ylabel('% successful runs', fontsize=50,weight='bold')
# bxs[1,1].legend(fontsize=30)
bxs[3,0].set_xlabel('fO$\mathregular{_{2}}$ ($\mathregular{\Delta}$FMQ)', fontsize=70,weight='bold')
